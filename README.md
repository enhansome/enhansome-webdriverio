...
**[WebdriverIO](https://github.com/webdriverio/webdriverio) ⭐ 9,817 | 🐛 361 | 🌐 TypeScript | 📅 2026-08-12** Next-gen browser and mobile automation test framework for Node.js
...
* [Wdi5](https://github.com/js-soft/wdi5) ⭐ 120 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-01 - Cross-platform test framework for hybrid UI5 apps. wdi5 = Webdriver.IO + UI5 Test API + appium.
...
* [LambdaTest](https://github.com/LambdaTest/wdio-lambdatest-service) ⭐ 9 | 🐛 10 | 🌐 JavaScript | 📅 2026-05-16 - Manage tunnel and job metadata for LambdaTest users.
...
* [Ng-apimock](https://github.com/ng-apimock/webdriverio-plugin) ⭐ 4 | 🐛 28 | 🌐 TypeScript | 📅 2023-03-06 - Service used by @ng-apimock/core.
* [SafariDriver](https://github.com/webdriverio-community/wdio-safaridriver-service) ⚠️ Archived - Run Safari browser seamlessly when running tests.
* [winappdriver](https://github.com/licanhua/wdio-winappdriver-service) ⚠️ Archived - Run WinAppDriver server seamlessly when running tests.
* [EdgeDriver](https://github.com/webdriverio-community/wdio-edgedriver-service) ⚠️ Archived - Run Microsoft Edge browser seamlessly when running tests.
* [Zafira Listener](https://github.com/shashidharus/wdio-zafira-listener-service) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2020-08-27 - Report tests to Zafira Dashboard.
* [CleanupTotal](https://github.com/tzurp/cleanup-total) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2025-08-05 - Proper cleanup after each test made easy.
* [Auto-detect missing imports w/eslint](https://github.com/jamesmortensen/wdio-eslinter-service) ⭐ 1 | 🐛 1 | 🌐 JavaScript | 📅 2022-03-16 - Automatically run eslint checks prior to executing tests.
* [ywinappdriver](https://github.com/licanhua/wdio-ywinappdriver-service) ⚠️ Archived - Run ywinappdriver server seamlessly when running tests.
...
* [Markdown](https://github.com/carmenmitru/wdio-markdown-reporter) ⭐ 3 | 🐛 1 | 🌐 JavaScript | 📅 2019-12-26 - Report results in Markdown format.
* [Video](https://github.com/presidenten/wdio-video-reporter) ⭐ 2 | 🐛 2 | 🌐 JavaScript | 📅 2023-10-18 - Makes videos of failed tests and has optional allure integration.
* [HTML](https://github.com/rpii/wdio-html-reporter) ⭐ 2 | 🐛 1 | 🌐 TypeScript | 📅 2024-10-29 - Generates a nice HTML report.
* [Delta Reporter](https://github.com/delta-reporter/delta-reporter-wdio) ⭐ 2 | 🐛 11 | 🌐 TypeScript | 📅 2023-03-04 - Report results in Delta Reporter format.
